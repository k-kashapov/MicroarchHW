...
lru_lip::lru_lip(CACHE *cache)
    : lru_lip(cache, cache->NUM_SET, cache->NUM_WAY) {}
...
void lru_lip::replacement_cache_fill(uint32_t triggering_cpu, long set,
...
void lru_lip::update_replacement_state(uint32_t triggering_cpu, long set,
                                       long way, champsim::address full_addr,
                                       champsim::address ip,
                                       champsim::address victim_addr,
